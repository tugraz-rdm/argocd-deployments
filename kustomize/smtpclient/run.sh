...
# --- Add unprivileged run configs ---
echo "deliver_drop_privilege='true'" >> $conf
echo "exim_user='exim'" >> $conf
echo "exim_group='exim'" >> $conf
...
chown exim:exim /var/lib/exim4/config.autogenerated
chmod 644 /var/lib/exim4/config.autogenerated
